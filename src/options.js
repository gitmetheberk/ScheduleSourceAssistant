...
save_config.addEventListener("click", async () =>{
    ...
    let selected_shifts = getSelectValuesFromFormSelect(document.getElementById("shifts"))
    ...
    chrome.storage.sync.set({
        ...
        before_minutes: getSelectValuesFromFormSelect(document.getElementById("before_minutes"))[0]
    });
});

// [9] https://stackoverflow.com/questions/11821261/how-to-get-all-selected-values-from-select-multiple-multiple
function getSelectValuesFromFormSelect(select) {
    var result = [];
